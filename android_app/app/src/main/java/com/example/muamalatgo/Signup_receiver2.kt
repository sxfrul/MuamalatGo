...
class Signup_receiver2 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_signup_receiver2)
        ...
        spinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(
                ...
                Toast.makeText(this@Signup_receiver2, "Anda pilih: $selected", Toast.LENGTH_SHORT).show()
            }
